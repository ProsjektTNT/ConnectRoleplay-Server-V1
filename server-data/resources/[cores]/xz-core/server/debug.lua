RegisterServerEvent('XZCore:DebugSomething')
AddEventHandler('XZCore:DebugSomething', function(resource, obj, depth)
...
XZCore.Debug = function(resource, obj, depth)
    TriggerEvent('XZCore:DebugSomething', resource, obj, depth)
end

XZCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

XZCore.ShowSuccess = function(resource, msg)
    print("\x1b[32m["..resource..":SUCCESS]\x1b[0m "..msg)
end
