...
--[[System Config]]--
IronS.LicenseKey = 'IROND99C08' -- Put your license key here
IronS.Logo = 'https://cdn.discordapp.com/attachments/860600829052583946/862984501549727784/LogoV99.gif' -- Put your server logo
IronS.ServerName = 'XZone FiveM Public' -- Put your server name
IronS.FileName = 'XZ' -- Name of your lua file for install (Default = IR.lua) // You can change this if you want

--[Webhook]--
IronS.BanWebhook = 'https://discord.com/api/webhooks/862985179781660673/Ls7g1LYpZaidv4qNSyZM1Y_MadCqNswV8KL9B6fl9XF_bo9bmfJGt72RqRCIgRt_bTlk' -- Put your ban webhook
IronS.LogWebhook = 'https://discord.com/api/webhooks/862985245292232734/BdJyGvYszXanowqx-kOea9J44A7hxQaFDYAjPQq1kgw_qGV_L3VfBIklpdPCRrvXOT_P' -- Put your log webhook
IronS.ScreenWebhook = 'https://discord.com/api/webhooks/862985294046298112/5GUDxL31hvKVdjWkjak4K0kaVqW3EnNmXraPiS9-WlfxuC82srhQht84qRbhQ7y-6qV1' -- Put your screenshot webhook

--[[Kick Message]]--
IronS.KickMessage = "רמת אמינות : אתה ציטר טוב :/" -- You can edit this

--[[Blacklist System]]--
IronS.ExplosionsAC = true -- Detects blacklisted explosions and who created them (tables/explosions.lua) // HIGHLY RECOMMENDED
IronS.BlacklistPed = false -- Detects blacklisted ped and remove (tables/blacklist.lua) // HIGHLY RECOMMENDED
IronS.BlacklistVeh = false -- Detects blacklisted vehicle and remove (tables/blacklist.lua) // HIGHLY RECOMMENDED

IronS.ObjectDetect = true -- Detects blacklisted object and remove // HIGHLY RECOMMENDED
IronS.AllObject = false -- If = true, All objects will be detected and deleted | If = false, will detect the objects contained here (tables/blacklist.lua)
...
IronS.ObjectBan = true -- Ban player who created blacklistobject (Works only if AllObject = false)


--[[Logs System]]--
IronS.PedsLog = false
IronS.VehiclesLog = false
IronS.ObjectsLog = true

--[[Onesync Configs]]-- You can edit numbers
IronS.MaxSpawner = false -- (Set = true to use the options below, set = false to disable)
IronS.MaxObject = 5000 -- Maximum number of objects the player can spawn in 1 minute, if over the player will be banned (Default = 80, set = 0 to disable)
IronS.MaxVehicle = 5000 -- Maximum number of vehicles the player can spawn in 1 minute, if over the player will be banned (Default = 80, set = 0 to disable)
IronS.MaxPed = 5000 -- Maximum number of peds the player can spawn in 1 minute, if over the player will be banned (Default = 80, set = 0 to disable)
...
IronS.ClearDetected = false -- Detects ClearPedTasksImmediately (Detects cheaters that are kicking out of vehicles other players) // HIGHLY RECOMMENDED
IronS.ClearDetectedBan = false -- Ban Player
