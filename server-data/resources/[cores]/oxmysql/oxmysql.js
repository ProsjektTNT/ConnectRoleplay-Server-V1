...
/***/ "./node_modules/connection-string-parser/dist/connection-string-parser.js":
/*!********************************************************************************!*\
  !*** ./node_modules/connection-string-parser/dist/connection-string-parser.js ***!
  \********************************************************************************/
...
(function (factory) {
    if ( true && typeof module.exports === "object") {
        var v = factory(__webpack_require__("./node_modules/connection-string-parser/dist sync recursive"), exports);
...
/***/ "./node_modules/connection-string-parser/dist sync recursive":
/*!**********************************************************!*\
  !*** ./node_modules/connection-string-parser/dist/ sync ***!
  \**********************************************************/
/***/ ((module) => {
...
webpackEmptyContext.id = "./node_modules/connection-string-parser/dist sync recursive";
...
exports.__defineGetter__(
  ...
  () => __webpack_require__(/*! ./promise.js */ "./node_modules/mysql2/promise.js").createConnection
);

exports.__defineGetter__(
  'createPoolPromise',
  () => __webpack_require__(/*! ./promise.js */ "./node_modules/mysql2/promise.js").createPool
);

exports.__defineGetter__(
  'createPoolClusterPromise',
  () => __webpack_require__(/*! ./promise.js */ "./node_modules/mysql2/promise.js").createPoolCluster
);
...
exports.__defineGetter__('CharsetToEncoding', () =>
  __webpack_require__(/*! ./lib/constants/charset_encodings.js */ "./node_modules/mysql2/lib/constants/charset_encodings.js")
);
...
const crypto = __webpack_require__(/*! crypto */ "crypto");
const { xor, xorRotating } = __webpack_require__(/*! ../auth_41 */ "./node_modules/mysql2/lib/auth_41.js");
...
const crypto = __webpack_require__(/*! crypto */ "crypto");
const { xor } = __webpack_require__(/*! ../auth_41 */ "./node_modules/mysql2/lib/auth_41.js");
...
try {
  highlightFn = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'cardinal'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).highlight;
} catch (err) {
  highlightFn = text => {
...
const ConnectionConfig = __webpack_require__(/*! ./connection_config */ "./node_modules/mysql2/lib/connection_config.js");
...
function createCompiler(config) {
  ...
  if (config.cache !== false && !cache) {
    cache = __webpack_require__(/*! lru-cache */ "./node_modules/named-placeholders/node_modules/lru-cache/index.js")({ max: ncache, dispose: EMPTY_LRU_FN });
  }
...
// A linked list to keep track of recently-used-ness
var Yallist = __webpack_require__(/*! yallist */ "./node_modules/named-placeholders/node_modules/yallist/yallist.js")
...
/* harmony export */   "slowQueryWarning": () => (/* binding */ slowQueryWarning),
/* harmony export */   "debug": () => (/* binding */ debug)
/* harmony export */ });
/* harmony import */ var connection_string_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! connection-string-parser */ "./node_modules/connection-string-parser/dist/connection-string-parser.js");
/* harmony import */ var connection_string_parser__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(connection_string_parser__WEBPACK_IMPORTED_MODULE_0__);
...
const config = new connection_string_parser__WEBPACK_IMPORTED_MODULE_0__.ConnectionStringParser({
  scheme: 'mysql',
  hosts: [],
...
/* harmony export */ });
/* harmony import */ var _pool__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pool */ "./src/pool.js");
...
const execute = async (query, parameters, resource) => {
  ...
  try {
    const time = _config__WEBPACK_IMPORTED_MODULE_2__.debug ? process.hrtime.bigint() : Date.now();

    [query, parameters] = (0,_parser__WEBPACK_IMPORTED_MODULE_1__.parseParameters)(query, parameters);

    const [result] = await _pool__WEBPACK_IMPORTED_MODULE_0__.pool.query(query, parameters);

    const executionTime = _config__WEBPACK_IMPORTED_MODULE_2__.debug ? Number(process.hrtime.bigint() - time) / 1e6 : Date.now() - time;

    if (executionTime >= _config__WEBPACK_IMPORTED_MODULE_2__.slowQueryWarning || _config__WEBPACK_IMPORTED_MODULE_2__.debug)
      console.log(
        `^3[${_config__WEBPACK_IMPORTED_MODULE_2__.debug ? 'DEBUG' : 'WARNING'}] ${resource} took ${executionTime}ms to execute a query!
    ...
    _config__WEBPACK_IMPORTED_MODULE_2__.debug && console.trace(error);
  }
};
...
/* harmony export */   "parseTypes": () => (/* binding */ parseTypes)
/* harmony export */ });
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./errors */ "./src/errors.js");
/* harmony import */ var named_placeholders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! named-placeholders */ "./node_modules/named-placeholders/index.js");
/* harmony import */ var named_placeholders__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(named_placeholders__WEBPACK_IMPORTED_MODULE_1__);



const convertNamedPlaceholders = named_placeholders__WEBPACK_IMPORTED_MODULE_1__();
...
const parseParameters = (query, parameters) => {
  if (query === undefined) throw new _errors__WEBPACK_IMPORTED_MODULE_0__.FormatError(`Undefined query passed`);
  ...
  if (parameters === undefined)
    throw new _errors__WEBPACK_IMPORTED_MODULE_0__.FormatError(`Placeholders was defined in query but no parameters provided!`, query);
  ...
  if (Array.isArray(parameters)) {
    ...
    queryParams.forEach((_, i) => {
      if (parameters[`${i + 1}`] === undefined) throw new _errors__WEBPACK_IMPORTED_MODULE_0__.FormatError(`Undefined object parameter #${i + 1}`, query, parameters);
    });
  }
...
/* harmony export */ });
/* harmony import */ var mysql2_promise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mysql2/promise */ "./node_modules/mysql2/promise.js");
...
const pool = (0,mysql2_promise__WEBPACK_IMPORTED_MODULE_0__.createPool)({
  host: _config__WEBPACK_IMPORTED_MODULE_1__.config.hosts[0].host || 'localhost',
  user: _config__WEBPACK_IMPORTED_MODULE_1__.config.username || 'root',
  password: _config__WEBPACK_IMPORTED_MODULE_1__.config.password || '',
  database: _config__WEBPACK_IMPORTED_MODULE_1__.config.endpoint || 'es_extended',
  charset: 'utf8mb4_unicode_ci',
  ..._config__WEBPACK_IMPORTED_MODULE_1__.config.options,
  namedPlaceholders: true,
  typeCast: _parser__WEBPACK_IMPORTED_MODULE_2__.parseTypes,
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _pool__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pool */ "./src/pool.js");
/* harmony import */ var _execute__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./execute */ "./src/execute.js");



setImmediate(async () => {
  try {
    await (await _pool__WEBPACK_IMPORTED_MODULE_0__.pool.getConnection()).ping();
...
global.exports('execute', (query, parameters, cb, resource = GetInvokingResource()) => {
  (0,_execute__WEBPACK_IMPORTED_MODULE_1__.execute)(query, parameters, resource).then((result) =>
...
if (!GetResourceMetadata(GetCurrentResourceName(), 'server_script', 1)) {
  global.exports('executeSync', async (query, parameters) => {
    const result = await (0,_execute__WEBPACK_IMPORTED_MODULE_1__.execute)(query, parameters, GetInvokingResource());
    return result;
  });
...
/******/ })()
;
//# sourceMappingURL=oxmysql.js.map