...
--	wisperZones = {
--		vector3(457.6314, -983.5424, 30.688884) -- Mission Raw Police Department
-- 		vector3(315.96429, -590.3937, 43.284053) -- Pillbox Hopistal
--	},
	...
	keySwitchChannelsSecondary = Keys["TAB"], -- If set, both the keySwitchChannels and keySwitchChannelsSecondary keybinds must be pressed to switch the radio channels
	...
	plugin_data = {
		...
		TSChannel = "FiveM Public - In Game",
		TSPassword = "TOHARHAGAMAD",
		TSChannelWait = "FiveM Public - Waiting Room",
		...
		TSServer = "xzone",
		TSChannelSupport = "Join Our Discord for Support",
		TSDownload = "https://files.teamspeak-services.com/releases/client/3.3.2/TeamSpeak3-Client-win64-3.3.2.exe", -- Download link displayed on blocking screen
