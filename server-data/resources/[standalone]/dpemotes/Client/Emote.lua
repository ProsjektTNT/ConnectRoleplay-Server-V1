...
RegisterNetEvent("xz:interact:init:" .. resourceName, function(Nevo)
	...
	Nevo.Mapping:Listen("emotemenu", "(Emotes) Emote Menu", "keyboard", "F3", function(state)
  ...
  Nevo.Mapping:Listen("cancelemote", "(Emotes) Cancel Emote", "keyboard", "X", function(state);
...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Emote Name type /emotes for a list', {{ name="emotename", help="dance, camera, sit or any valid emote."}})
