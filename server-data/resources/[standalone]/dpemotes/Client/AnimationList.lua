...
DP.Emotes = {
   ...
   ["crossarms6"] = {"amb@world_human_hang_out_street@male_c@idle_b", "idle_d", "Crossarms 6", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["surrender2"] = {"anim@mp_player_intuppersurrender", "idle_a_fp", "Surrender 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["lean5"] = {"amb@world_human_leaning@male@wall@back@foot_up@aggro_react", "aggro_react_forward_enter", "Lean 5", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ...
   ["gangsign4"] = {"amb@code_human_in_car_mp_actions@gang_sign_a@std@rds@base", "idle_a", "Gang Sign 4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["cpr3"] = {"mini@cpr@char_a@cpr_str", "cpr_kol", "CPR 3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ...
   ["threaten2"] = {"combat@aim_variations@1h@gang", "aim_variation_d", "Threaten 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["threaten3"] = {"combat@aim_variations@1h@hillbilly", "aim_variation_e", "Threaten 3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["threaten4"] = {"combat@chg_stance", "aima_loop", "Threaten 4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
...
-----------------------------------------------------------------------------------------------------------
   ...
   ["shinetorch"] = {"Scenario", "WORLD_HUMAN_SECURITY_SHINE_TORCH", "Shine Torch"},
