...
RegisterServerEvent("dpemotes:saveWalkMode", function(walk)
	local src = source
...
if Config.SqlKeybinding then
  CreateThread(function()
	...
	RegisterServerEvent("dp:ServerKeybindExist", function()
		local src = source 
		local srcid = GetPlayerIdentifier(source)
		XZCore.Functions.ExecuteSql(false, "SELECT * FROM dpkeybinds WHERE `id`= '" .. srcid .."';", function(dpkeybinds)
	...
	RegisterServerEvent("dp:ServerKeybindCreate", function()
		local src = source local srcid = GetPlayerIdentifier(source)
		XZCore.Functions.ExecuteSql(false, "INSERT INTO dpkeybinds (`id`, `keybind1`, `emote1`, `keybind2`, `emote2`, `keybind3`, `emote3`, `keybind4`, `emote4`, `keybind5`, `emote5`, `keybind6`, `emote6`) VALUES ('" .. srcid .. "', 'num4', '', 'num5', '', 'num6', '', 'num7', '', 'num8', '', 'num9', '');",  function(created) print("[dp] ^2"..GetPlayerName(src).."^7 got created!") TriggerClientEvent("dp:ClientKeybindGet", src, "num4", "", "num5", "", "num6", "", "num7", "", "num8", "", "num8", "") end)
	end)

	RegisterServerEvent("dp:ServerKeybindGrab", function()
		local src = source local srcid = GetPlayerIdentifier(source)
		XZCore.Functions.ExecuteSql(false, 'SELECT keybind1, emote1, keybind2, emote2, keybind3, emote3, keybind4, emote4, keybind5, emote5, keybind6, emote6 FROM `dpkeybinds` WHERE `id` = \'' .. srcid .. '\'', function(kb)
	...
	RegisterServerEvent("dp:ServerKeybindUpdate", function(key, emote)
		...
		if chosenk == "keybind1" then
			XZCore.Functions.ExecuteSql(false,"UPDATE dpkeybinds SET emote1='" .. emote .. "' WHERE id='" .. myid .. "'", function() 
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote) 
			end)
		elseif chosenk == "keybind2" then
			XZCore.Functions.ExecuteSql(false,"UPDATE dpkeybinds SET emote2='" .. emote .. "' WHERE id='" .. myid .. "'", function() 
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote) 
			end)
		elseif chosenk == "keybind3" then
			XZCore.Functions.ExecuteSql(false,"UPDATE dpkeybinds SET emote3='" .. emote .. "' WHERE id='" .. myid .. "'", function() 
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote) 
			end)
		elseif chosenk == "keybind4" then
			XZCore.Functions.ExecuteSql(false,"UPDATE dpkeybinds SET emote4='" .. emote .. "' WHERE id='" .. myid .. "'", function() 
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote) 
			end)
		elseif chosenk == "keybind5" then
			XZCore.Functions.ExecuteSql(false,"UPDATE dpkeybinds SET emote5='" .. emote .. "' WHERE id='" .. myid .. "'", function() 
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote) 
			end)
		elseif chosenk == "keybind6" then
			XZCore.Functions.ExecuteSql(false,"UPDATE dpkeybinds SET emote6='" .. emote .. "' WHERE id='" .. myid .. "'", function() 
				TriggerClientEvent("dp:ClientKeybindGetOne", src, key, emote) 
			end)
		end
	end)
