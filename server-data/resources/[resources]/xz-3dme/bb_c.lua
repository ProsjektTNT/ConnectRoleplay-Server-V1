                        ...
                        if not l then
                            c =
                                c .. '<p style=\'left: ' .. m * 100 .. '%;top: ' ..
                                    n * 100 ..
                                    '%;;text-shadow: 1px 0px 5px #000000FF, -1px 0px 0px #000000FF, 0px -1px 0px #000000FF, 0px 1px 5px #000000FF;-webkit-transform: translate(-50%, 0%);max-width: 100%;position: fixed;text-align: center;color: #FFFFFF;background: rgba(18, 18, 18, 0.5);border-radius:3px;font-family:custom;font-size: 14px;\'><b style=\'opacity: 1.0;\'>⠀' ..
                                    e.msg .. '⠀</b></p>'
                        end
                    elseif e.type == 'do' then
                        ...
                        if not l then
                            c =
                                c .. '<p style=\'left: ' .. m * 100 .. '%;top: ' ..
                                    n * 100 ..
                                    '%;;text-shadow: 1px 0px 5px #000000FF, -1px 0px 0px #000000FF, 0px -1px 0px #000000FF, 0px 1px 5px #000000FF;-webkit-transform: translate(-50%, 0%);max-width: 100%;position: fixed;text-align: center;color: #FFFFFF;background: rgba(18, 18, 18, 0.5);border-radius:3px;font-family:custom;font-size: 14px;\'><b style=\'opacity: 1.0;color: #ef87ff\'>⠀' ..
                                    e.msg .. '⠀</b></p>'
                        end
                    end
                end
