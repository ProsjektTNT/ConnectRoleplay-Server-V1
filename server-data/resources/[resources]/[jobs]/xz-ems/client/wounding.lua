...
AddEventHandler('hospital:client:UseBandage', function()
    XZCore.Functions.Progressbar("use_bandage", "Healing", 5000, false, true, {
        ...
        TriggerServerEvent("XZCore:Server:RemoveItem", "bandage", 1)
        TriggerEvent("inventory:client:ItemBox", XZCore.Shared.Items["bandage"], "remove")
...
AddEventHandler('hospital:client:UseFirstAid', function()
    XZCore.Functions.Progressbar("use_firstaid", "Healing", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@world_human_clipboard@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("XZCore:Server:RemoveItem", "firstaid", 1)
        TriggerEvent("inventory:client:ItemBox", XZCore.Shared.Items["firstaid"], "remove")
...
AddEventHandler('hospital:client:UseMedkit', function()
    XZCore.Functions.Progressbar("use_medkit", "Healing", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@world_human_clipboard@male@idle_a", "idle_c", 1.0)
        TriggerServerEvent("XZCore:Server:RemoveItem", "medkit", 1)
        TriggerEvent("inventory:client:ItemBox", XZCore.Shared.Items["medkit"], "remove")
...
AddEventHandler('hospital:client:UsePainkillers', function()
    XZCore.Functions.Progressbar("use_bandage", "Consuming Painkillers", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        TriggerServerEvent("XZCore:Server:RemoveItem", "painkillers", 1)
        TriggerEvent("inventory:client:ItemBox", XZCore.Shared.Items["painkillers"], "remove")
