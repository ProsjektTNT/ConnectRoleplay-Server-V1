...
Config.OxyAmount = 1 -- How much oxy you get when RN Jesus gives you oxy. Default: 4.
...
Config.BigRewarditem = "advancedlockpick" -- Put a rare item here which will have 50% chance of being given on the run.
