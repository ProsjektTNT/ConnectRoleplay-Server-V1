...
RegisterNetEvent("xz-dices:ToggleDisplay", function(playerId, number, typ)
...
RegisterNetEvent("xz-scripts:client:locationChange", function(typ)
    TriggerServerEvent('xz-scripts:locationChange:' .. typ)
end)

RegisterNetEvent("xz-dices:ToggleDiceAnim", function()
