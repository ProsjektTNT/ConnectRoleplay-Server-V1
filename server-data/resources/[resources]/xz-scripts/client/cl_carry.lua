...
local t, distance = XZCore.Functions.GetClosestPlayer()
...
beingCarried = false
TriggerServerEvent("xz-carry:beingCarried", beingCarried)
else
...
AddEventHandler('undragPlayer', function()
ClearPedTasksImmediately(PlayerPedId())
beingCarried = false
