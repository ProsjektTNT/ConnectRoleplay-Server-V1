...
function TaskItem(dictionary,animation,typeAnim,timer,message,func,remove,itemid,playerVeh)
    ...
    if timer > 0 then
        XZCore.Functions.Progressbar("idkidk", message, timer, false, true, {
...
function AttachPropAndPlayAnimation(dictionary,animation,typeAnim,timer,message,func,remove,itemid,vehicle)
    ...
    elseif itemid == "bscoffee" then
        TriggerEvent("attachItem", "bscoffee")
    elseif itemid == "softdrink" then
        TriggerEvent("attachItem", "softdrink")
    elseif itemid == "fries" then
...
RegisterNetEvent('xz-food:useFood')
AddEventHandler('xz-food:useFood', function(itemid)

    if (itemid == "burger" or itemid == "taco" or itemid == "fishtaco" or itemid == "burrito" or itemid == "torpedo" or itemid == "torta" or itemid == "fowlburger" or itemid == "bleederburger" or itemid == "moneyshot" or itemid == "heartstopper" or itemid == "meatfree" or itemid == "sandwich" or itemid == "toast" or itemid == "pizza" or itemid == "jailfood") then
    ...
    if itemid == "softdrink" then
        AttachPropAndPlayAnimation("amb@world_human_drinking@coffee@male@idle_a", "idle_c", 49,15000,"Drink","consumables:client:DrinkS",true,itemid,playerVeh)
    end
    ...
    if (itemid == "coffee" or itemid == "frappuccino" or itemid == "latte" or itemid == "bscoffee" or itemid == "capuchino") then
        AttachPropAndPlayAnimation("amb@world_human_drinking@coffee@male@idle_a", "idle_c", 49,6000,"Drink","consumables:client:DrinkS", true,itemid,playerVeh)
    end
