...
$(document).on('click', '.mail', function(e){
    ...
    XZ.Phone.Functions.SetupMail(MailData);
...
$(document).on('click', '#accept-mail', function(e){
    ...
    $.post('https://xz-phone/AcceptMailButton', JSON.stringify({
...
$(document).on('click', '#remove-mail', function(e){
    e.preventDefault();
    var MailData = $("#"+OpenedMail).data('MailData');
    $.post('https://xz-phone/RemoveMail', JSON.stringify({
        mailId: MailData.mailid
    }));
    $(".mail-home").animate({
        left: 0+"vh"
...
XZ.Phone.Functions.SetupMails = function(Mails) {
    ...
    $("#mail-header-mail").html(XZ.Phone.Data.PlayerData.charinfo.firstname+"."+XZ.Phone.Data.PlayerData.charinfo.lastname+"@x-zone.com");
...
XZ.Phone.Functions.SetupMail = function(MailData) {
...
$(document).on('click', '#new-advert-submit', function(e){
    ...
    if (Advert !== "") {
        ...
        $.post('https://xz-phone/PostAdvert', JSON.stringify({
            message: Advert,
        }));
    } else {
        XZ.Phone.Notifications.Add("fas fa-ad", "Advertisement", "You can\'t post an empty ad!", "#ff8f1a", 2000);
    }
});

XZ.Phone.Functions.RefreshAdverts = function(Adverts) {
    $("#advert-header-name").html("@"+XZ.Phone.Data.PlayerData.charinfo.firstname+""+XZ.Phone.Data.PlayerData.charinfo.lastname+" | "+XZ.Phone.Data.PlayerData.charinfo.phone);
