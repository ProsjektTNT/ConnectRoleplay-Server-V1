...
$(document).on('click', '.phone-app-footer-button', function(e){
    ...
    if (PressedFooterTab !== CurrentFooterTab) {
        ...
        if (PressedFooterTab == "recent") {
            $.post('https://xz-phone/ClearRecentAlerts');
...
XZ.Phone.Functions.SetupRecentCalls = function(recentcalls) {
...
$(document).on('click', '.phone-recent-call', function(e){
    ...
    console.log(XZ.Phone.Data.AnonymousCall)

    $.post('https://xz-phone/CallContact', JSON.stringify({
        ContactData: cData,
        Anonymous: XZ.Phone.Data.AnonymousCall,
    }), function(status){
        if (cData.number !== XZ.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (XZ.Phone.Data.AnonymousCall) {
                            XZ.Phone.Notifications.Add("fas fa-phone", "Phone", "You started a anonymous call!");
                        }
                        $(".phone-call-outgoing").css({"display":"block"});
                        $(".phone-call-incoming").css({"display":"none"});
                        $(".phone-call-ongoing").css({"display":"none"});
                        $(".phone-call-outgoing-caller").html(cData.name);
                        XZ.Phone.Functions.HeaderTextColor("white", 400);
                        XZ.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
                        setTimeout(function(){
                            $(".phone-app").css({"display":"none"});
                            XZ.Phone.Animations.TopSlideDown('.phone-application-container', 400, 0);
                            XZ.Phone.Functions.ToggleApp("phone-call", "block");
                        }, 450);
    
                        CallData.name = cData.name;
                        CallData.number = cData.number;
                    
                        XZ.Phone.Data.currentApplication = "phone-call";
                    } else {
                        XZ.Phone.Notifications.Add("fas fa-phone", "Phone", "You're already in a call!");
                    }
                } else {
                    XZ.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is busy!");
                }
            } else {
                XZ.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not available!");
            }
        } else {
            XZ.Phone.Notifications.Add("fas fa-phone", "Phone", "You can't call yourself!");
        }
    });
});
...
XZ.Phone.Functions.LoadContacts = function(myContacts) {
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== XZ.Phone.Data.PlayerData.charinfo.phone) {
        ...
        setTimeout(function(){
            ...
            XZ.Phone.Functions.ToggleApp("phone", "none");
            XZ.Phone.Functions.ToggleApp("whatsapp", "block");
            XZ.Phone.Data.currentApplication = "whatsapp";
        
            $.post('https://xz-phone/GetWhatsappChat', JSON.stringify({phone: ContactData.number}), function(chat){
                XZ.Phone.Functions.SetupChatMessages(chat, {
        ...
        XZ.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "You can't whatsapp yourself..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact', function(e){
    ...
    XZ.Phone.Animations.TopSlideDown(".phone-edit-contact", 200, 0);
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://xz-phone/EditContact', JSON.stringify({
            ...
            XZ.Phone.Functions.LoadContacts(PhoneContacts);
        });
        XZ.Phone.Animations.TopSlideUp(".phone-edit-contact", 250, -100);
        setTimeout(function(){
            $(".phone-edit-contact-number").val("");
            $(".phone-edit-contact-name").val("");
        }, 250)
    } else {
        XZ.Phone.Notifications.Add("fas fa-exclamation-circle", "Edit Contact", "Fill out all fields!");
    }
});
...
$(document).on('click', '#edit-contact-delete', function(e){
    ...
    $.post('https://xz-phone/DeleteContact', JSON.stringify({
        CurrentContactName: ContactName,
        CurrentContactNumber: ContactNumber,
        CurrentContactIban: ContactIban,
    }), function(PhoneContacts){
...
$(document).on('click', '#phone-plus-icon', function(e){
    ...
    XZ.Phone.Animations.TopSlideDown(".phone-add-contact", 200, 0);
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://xz-phone/AddNewContact', JSON.stringify({
        ...
        XZ.Phone.Animations.TopSlideUp(".phone-add-contact", 250, -100);
        setTimeout(function(){
        ...
        if (SelectedSuggestion !== null) {
            $.post('https://xz-phone/RemoveSuggestion', JSON.stringify({
        ...
        XZ.Phone.Notifications.Add("fas fa-exclamation-circle", "Add Contact", "Fill out all fields!");
    }
});
        ...
        if (cData.number !== XZ.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    XZ.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is in a call!");
                }
            } else {
                XZ.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not available!");
            }
        } else {
            XZ.Phone.Notifications.Add("fas fa-phone", "Phone", "You can't call your own number!");
        }
    });
}

CancelOutgoingCall = function() {
    if (XZ.Phone.Data.currentApplication == "phone-call") {
        XZ.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
    ...
    if (!Canceled) {
        if (!XZ.Phone.Data.CallActive) {
            ...
            setTimeout(function(){
                ...
                $(".phone-app").css({"display":"none"});
                XZ.Phone.Functions.HeaderTextColor("white", 400);
                $("."+XZ.Phone.Data.currentApplication+"-app").css({"display":"none"});
...
XZ.Phone.Functions.SetupCurrentCall = function(cData) {
    if (cData.InCall) {
        CallData = cData;
...
$(document).on('click', '.phone-currentcall-container', function(e){
    ...
    XZ.Phone.Functions.HeaderTextColor("white", 500);
    XZ.Phone.Animations.TopSlideDown('.phone-application-container', 500, 0);
    XZ.Phone.Animations.TopSlideDown('.phone-call-app', 500, 0);
    XZ.Phone.Functions.ToggleApp("phone-call", "block");
...
$(document).on('click', '#incoming-answer', function(e){
    ...
    $.post('https://xz-phone/AnswerCall');
});

XZ.Phone.Functions.AnswerCall = function(CallData) {
    $(".phone-call-incoming").css({"display":"none"});
    $(".phone-call-outgoing").css({"display":"none"});
    $(".phone-call-ongoing").css({"display":"block"});
...
XZ.Phone.Functions.SetupSuggestedContacts = function(Suggested) {
