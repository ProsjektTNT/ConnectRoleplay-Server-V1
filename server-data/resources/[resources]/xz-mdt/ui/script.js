    ...
    methods: {
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('https://xz-mdt/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('https://xz-mdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('https://xz-mdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('https://xz-mdt/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post('https://xz-mdt/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('https://xz-mdt/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('https://xz-mdt/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('https://xz-mdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('https://xz-mdt/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('https://xz-mdt/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('https://xz-mdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('https://xz-mdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('https://xz-mdt/getReport', JSON.stringify({
                id: id
            }));
            this.modal = 'loading';
            return;
        ...
        AttachToCall(index) {
            $.post('https://xz-mdt/attachToCall', JSON.stringify({
                index: index,
        ...
        DetachFromCall(index) {
            $.post('https://xz-mdt/detachFromCall', JSON.stringify({
                index: index
            }));
            this.current_call = {
                source: null,
        ...
        SetCallWaypoint(index) {
            $.post('https://xz-mdt/setCallWaypoint', JSON.stringify({
                coords: this.calls[index].coords
            }));
            return;
        },
        ...
        SaveEditCall() {
            $.post('https://xz-mdt/editCall', JSON.stringify({
        ...
        DeleteCall(index) {
            $.post('https://xz-mdt/deleteCall', JSON.stringify({
                index: index
            }));
            return;
        },
        ...
        SaveVehicleEditChanges() {
            $.post('https://xz-mdt/saveVehicleChanges', JSON.stringify({
        ...
        window.addEventListener('message', function(event) {
            if (event.data.type == "enable") {
                ...
                if (mdtApp.current_call.id == mdtApp.calls[event.data.call].id) {
                    $.post('https://xz-mdt/deleteCallBlip')
                    mdtApp.current_call = {
                        source: null,
                        details: null,
                        id: null,
