...
RegisterNetEvent("mdt:toggleVisibilty", function(reports, warrants, officer, job, grade)
    local playerPed = PlayerPedId()
...
RegisterNetEvent("mdt:returnOffenderSearchResults", function(results)
    SendNUIMessage({
...
RegisterNetEvent("mdt:closeModal", function()
    SendNUIMessage({
        type = "closeModal"
    })
end)

RegisterNetEvent("mdt:returnOffenderDetails", function(data)
...
RegisterNetEvent("mdt:returnOffensesAndOfficer", function(data, name)
    SendNUIMessage({
...
RegisterNetEvent("mdt:returnReportSearchResults", function(results)
    SendNUIMessage({
...
RegisterNetEvent("mdt:returnVehicleSearchInFront", function(results, plate)
    SendNUIMessage({
...
RegisterNetEvent("mdt:returnVehicleSearchResults", function(results)
    SendNUIMessage({
...
RegisterNetEvent("mdt:returnVehicleDetails", function(data)
...
RegisterNetEvent("mdt:returnWarrants", function(data)
    SendNUIMessage({
...
RegisterNetEvent("mdt:completedWarrantAction", function(data)
    SendNUIMessage({
        type = "completedWarrantAction"
    })
end)

RegisterNetEvent("mdt:returnReportDetails", function(data)
    SendNUIMessage({
...
RegisterNetEvent("mdt:sendNUIMessage", function(messageTable)
    SendNUIMessage(messageTable)
end)

RegisterNetEvent("mdt:sendNotification", function(message)
    SendNUIMessage({
...
RegisterNetEvent("mdt:getNewCallCoords", function(details, callid)
    local coords = GetEntityCoords(PlayerPedId())
    TriggerServerEvent("mdt:newCall", details, callid, coords)
end)

RegisterNetEvent("mdt:newCall", function(details, callid, coords, index)
...
RegisterNetEvent("mdt:newCallAttach", function(index, charname)
    SendNUIMessage({
        type = "newCallAttach",
        call = index,
        charname = charname
...
RegisterNetEvent("mdt:newCallDetach", function(index, charname)
    SendNUIMessage({
        type = "newCallDetach",
        call = index,
        charname = charname
...
RegisterNetEvent("mdt:deleteCall", function(index)
    SendNUIMessage({
        type = "deleteCall",
        call = index
    })
