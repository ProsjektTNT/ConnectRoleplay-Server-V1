...
RegisterNetEvent('destroyPropPerm', function()
...
RegisterNetEvent('attachPropPerm', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
...
RegisterNetEvent('attachProp', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	removeAttachedProp()
	attachModel = GetHashKey(attachModelSent)
	boneNumber = boneNumberSent
	SetCurrentPedWeapon(PlayerPedId(), 0xA2719263)
...
RegisterNetEvent('destroyPropPhone', function()
	removeAttachedPropPhone()
end)

RegisterNetEvent('attachPropPhone', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	removeAttachedPropPhone()
...
RegisterNetEvent('destroyPropRadio', function()
	removeAttachedPropRadio()
end)

RegisterNetEvent('attachPropRadio', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	removeAttachedPropRadio()
...
RegisterNetEvent('destroyProp69', function()
	removeAttachedProp69()
end)

RegisterNetEvent('attachProp69', function(attachModelSent,boneNumberSent,x,y,z,xR,yR,zR)
	removeAttachedProp69()
