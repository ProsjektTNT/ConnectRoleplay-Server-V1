...
exports("SetPedClothing", function(ped, drawables, props, proptextures)
    player = ped;
    SetClothing(drawables, props, drawtextures, proptextures);
    player = PlayerPedId();
end);

exports("SetPedFace", function(ped, headBlend, haircolor, headStructure, headOverlay)
    player = ped;

    SetPedHeadBlendData(player,
        tonumber(headBlend['shapeFirst']),
        tonumber(headBlend['shapeSecond']),
        tonumber(headBlend['shapeThird']),
        tonumber(headBlend['skinFirst']),
        tonumber(headBlend['skinSecond']),
        tonumber(headBlend['skinThird']),
        tonumber(headBlend['shapeMix']),
        tonumber(headBlend['skinMix']),
        tonumber(headBlend['thirdMix']),
    false)
...
RegisterNetEvent("xz-clothing:stealOutfit", function(cheater)
    TriggerServerEvent("xz-clothing:letSteal", cheater, GetCurrentPed())
end)

RegisterNetEvent("xz-clothing:letSteal", function(data)
    ForceOutfit = GetCurrentPed()
    LoadPed(data)
end)

RegisterNetEvent("xz-clothing:getOutfit", function(data)
    LoadPed(data)
end)

RegisterNetEvent("xz-clothing:restoreOutfit", function()
    if ForceOutfit then
        LoadPed(ForceOutfit)
    end
end)