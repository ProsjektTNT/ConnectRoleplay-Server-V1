...
# A Mechanic Job for XZCore Framework
...
- No support will be given to people using scripts created outside of the XZCore Framework meaning external scripts such as aj-inventory.


## Dependencies :

QB Framework - https://github.com/XZCore-framework/xz-core

PolyZone - https://github.com/mkafrin/PolyZone

xz-target - https://github.com/BerkieBb/xz-target
...
## Insert into #xz-core - Shared.lua
...
## Insert into #xz-bossmenu - config.lua
```
['gasmonkey'] = vector3(, , )),
```

## Insert into #xz-target - config.lua - config.targetmodels
```
Config.TargetBones = {
["mechanic"] = {
        bones = {
