...
RegisterNetEvent("xz-outfits:client:tryUI")
AddEventHandler("xz-outfits:client:tryUI", function(outfits, tsd)
    local plyPed = PlayerPedId()
    local plyCoords = GetEntityCoords(plyPed)
    if tsd then
        TriggerEvent("xz-outfits:client:openUI", outfits)
        return
    end
...
RegisterNetEvent("xz-outfits:client:openUI")
AddEventHandler("xz-outfits:client:openUI", function(outfits)
    local html = ""
...
RegisterNetEvent("xz-outfits:client:uiForce")
AddEventHandler("xz-outfits:client:uiForce", function()
    TriggerServerEvent("xz-outfits:server:openUI", true)
end)

RegisterNetEvent("xz-outfits:client:updateUI")
AddEventHandler("xz-outfits:client:updateUI", function(outfits)
    local html = ""
...
RegisterNetEvent("xz-outfits:client:SetClothing")
AddEventHandler("xz-outfits:client:SetClothing", function(data)
...
RegisterNUICallback('CreateOutfit', function(data)
    ...
    TriggerServerEvent("xz-outfits:server:create", data.slot, data.name, temp_data)
end)

RegisterNUICallback('DeleteOutfit', function(data)
    TriggerServerEvent("xz-outfits:server:delete", data.slot)
end)

RegisterNUICallback('SelectOutfit', function(data)
    TriggerServerEvent("xz-outfits:server:use", data.slot)
end)
