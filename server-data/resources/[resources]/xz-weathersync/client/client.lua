...
RegisterNetEvent('XZCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('xz-weathersync:server:RequestStateSync')
    TriggerServerEvent('xz-weathersync:server:RequestCommands')
end)

RegisterNetEvent('xz-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('xz-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('xz-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('xz-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('xz-weathersync:client:RequestCommands', function(isAllowed)
    if isAllowed then
...
RegisterNetEvent('xz-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
